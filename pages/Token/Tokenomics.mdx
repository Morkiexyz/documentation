...
Our tokenomics are strategically structured to promote a robust and equitable ecosystem. The allocation of our total token supply is as follows, ensuring a sum of 100%:
...
We would like to inform our valued users that the current vesting schedule is subject to further refinement. Our team is dedicated to establishing a vesting framework that is both prudent and adaptable to the evolving dynamics of our platform.
